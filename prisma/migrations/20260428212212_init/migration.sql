...
-- CreateIndex
CREATE UNIQUE INDEX "Status_workspaceId_key_key" ON "Status"("workspaceId", "key");

-- CreateIndex
CREATE INDEX "Ticket_workspaceId_statusId_position_idx" ON "Ticket"("workspaceId", "statusId", "position");
...
-- AddForeignKey
ALTER TABLE "Ticket" ADD CONSTRAINT "Ticket_statusId_fkey" FOREIGN KEY ("statusId") REFERENCES "Status"("id") ON DELETE CASCADE ON UPDATE CASCADE;
