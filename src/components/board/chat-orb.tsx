              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="inline-flex h-5 w-5 flex-shrink-0 items-center justify-center self-center rounded text-muted-foreground transition-colors hover:text-foreground focus-visible:text-foreground focus-visible:outline-none"
                  >
                    <HelpCircle className="h-3.5 w-3.5" aria-hidden />
                  </button>
                </TooltipTrigger>
                <TooltipContent side="top" sideOffset={6} className="max-w-[15rem] text-center">
                  Auto-run dispatches the selected workflow as soon as a ticket is created. Pick a
                  different workflow to switch, or open the picker to disable it.
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
