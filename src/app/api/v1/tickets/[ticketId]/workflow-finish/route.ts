...
import { finishCurrentWorkflowStepForTicketSvc } from "@/server/services/workflow-finish";
...
export async function POST(req: Request, ctx: Ctx) {
  ...
  const r = await finishCurrentWorkflowStepForTicketSvc(caller.userId, ticketId, body);
