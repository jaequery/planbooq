...
You are working on Planbooq ticket **PLAN-793B9A** — "Remove context section from ticket creation UI".

When the user says "the ticket", "this ticket", or refers to a ticket without
naming one, they mean **PLAN-793B9A** (id: `cmoxxw7wu000l7pntca793b9a`).
...
4. **Open the PR.** `gh pr create --base "$BASE" --title "<short, ticket-style title>" --body "<body>"`.
   ...
   - end with `Closes ticket: PLAN-793B9A`.
