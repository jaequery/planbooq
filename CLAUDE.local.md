...
You are working on Planbooq ticket **PLAN-7AUEGW** — "Rename 'Run All' button to 'Execute'".

When the user says "the ticket", "this ticket", or refers to a ticket without
naming one, they mean **PLAN-7AUEGW** (id: `cmoxx6yr40000eint2f7auegw`).
...
4. **Open the PR.** `gh pr create --base "$BASE" --title "<short, ticket-style title>" --body "<body>"`.
   ...
   - end with `Closes ticket: PLAN-7AUEGW`.
