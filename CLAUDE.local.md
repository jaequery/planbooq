...
You are working on Planbooq ticket **PLAN-FNKQYC** — "Replace circle dot icon for priority levels with distinct visual indicator".

When the user says "the ticket", "this ticket", or refers to a ticket without
naming one, they mean **PLAN-FNKQYC** (id: `cmoylkyw7000ieuntiufnkqyc`).
...
4. **Open the PR.** `gh pr create --base "$BASE" --title "<short, ticket-style title>" --body "<body>"`.
   ...
   - end with `Closes ticket: PLAN-FNKQYC`.
